...
- `buku/list.html` — tabel daftar buku statis (5 baris dummy).
  ...
  ![Screenshot](../jobsheet-01/Dokumentasi/img/buku-list.png)

- `buku/tambah.html` — form tambah buku (belum diproses).

  ![Screenshot](../jobsheet-01/Dokumentasi/img/buku-tambah.png)

- `anggota/list.html` — tabel daftar anggota statis (tugas mandiri).

  ![Screenshot](../jobsheet-01/Dokumentasi/img/anggota-list.png)
